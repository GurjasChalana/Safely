...
export function hideBanner(): void {
  // Close the conversation panel first so its _active flag is reset.
  // This prevents the stale flag from blocking a fresh openConversation
  // call when the banner is re-rendered after enrichment completes.
  closeConversation();
